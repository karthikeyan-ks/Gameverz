...
SECRET_KEY = 'django-insecure-dnp*uks-y1kpi_unh048*g8!vb8pam12i5sy82g9=g=&nj20sj'
...
# (optional) if you're using custom static files in development
# STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]


# If using static inside apps or anywhere
STATICFILES_DIRS = [
